...
provider_applicant_id = Column(
    String(128),
    nullable=True,
    index=True,
)

provider_external_user_id = Column(
    String(512),
    nullable=True,
    index=True,
)

provider_level_name = Column(
    String(256),
    nullable=True,
)

provider_review_answer = Column(
    String(32),
    nullable=True,
)

provider_reject_type = Column(
    String(32),
    nullable=True,
)
